...
const products = [
  {
    id: 1,
    title: "Best clothes collection for your style",
    subTitle: "Welcome to Boutique",
             ...
             products?.map((product) => (
              <div key={product?.id} className="banner_slide_item">
                ...
                <div className="banner_text">
                  ...
                  <h3 className="text-6xl text-[#272343] font-inter capitalize leading-16 max-w-[631x] w-full font-bold mb-5">{product?.title}</h3>
