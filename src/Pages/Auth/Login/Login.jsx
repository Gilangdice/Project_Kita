    ...
    <div className="lg:container mx-auto p-[80px]">
      <div className="max-w-[648px] w-full min-h-[382px] p-[31px] mx-auto flex items-center justify-center flex-col rounded-lg border-[1px] border-[#9a9caa]">
        ...
        <form action="#" onSubmit={submitHandle} className=" flex flex-col items-center w-full space-y-4">
          ...
          <button type="submit" className="w-full h-[50px] bg-[#007580] rounded-lg pl-3.5 text-base text-white font-inter font-semibold capitalize flex items-center justify-center cursor-pointer gap-2.5">login<MoveRight /></button>
        </form>
        <p className="text-[#272343] text-base font-inter font-normal mt-4 flex items-center justify-center gap-2.5">Don't have an account? <Link to={"/auth/register"} className="text-[#007580]">Register</Link></p>
      </div>
    </div>
  )
}
